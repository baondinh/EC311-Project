namespace eval ::optrace {
  variable script "X:/Bao/project_rough/project_rough.runs/impl_1/vga_top.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir X:/Bao/project_rough/project_rough.cache/wt [current_project]
